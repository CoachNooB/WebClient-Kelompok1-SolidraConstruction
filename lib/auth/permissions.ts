...
const grants: Record<StaffRole, ReadonlySet<Permission>> = {
  SUPER_ADMIN: new Set(["content:read", "content:write", "content:publish", "submissions:read", "submissions:write", "users:manage", "settings:manage"]),
  EDITOR: new Set(["content:read", "content:write", "content:publish", "submissions:read", "submissions:write", "settings:manage"]),
